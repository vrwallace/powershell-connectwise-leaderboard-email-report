...
"@    
        ...
        FROM [cwwebapp_].[dbo].[v_company_time] where (( sr_status='Closed') and ( date>=DATEADD(week, DATEDIFF(week, 0, getdate()), 0) )) group by resource order by count(resource) desc;
        "
  ...
  <th style=`"width:20%`">&#9734; Ranking &#9734;</th> 
    ...
    <th style=`"width:20%`">Hours Billed</th>
        ...
        $sql = $sql + "`r`nSELECT top 100 resource, count(resource) as 'Closed Tickets',sum(Hours_bill) as 'Hours Billed' 
FROM [cwwebapp_].[dbo].[v_company_time] where (( sr_status='Closed') and ( date>=DATEADD(month, DATEDIFF(month, 0, getdate()), 0) )) group by resource order by count(resource) desc;"
...
<th style=`"width:20%`">Hours Billed</th>
        ...
        $sql = $sql + "`r`nSELECT top 100 resource, count(resource) as 'Closed Tickets',sum(Hours_bill) as 'Hours Billed' 
FROM [cwwebapp_].[dbo].[v_company_time] where (( sr_status='Closed') and ( date>=DATEADD(year, DATEDIFF(year, 0, getdate()), 0) )) group by resource order by count(resource) desc;"
...
<th style=`"width:20%`">Hours Billed</th>
        ...
        $sql = $sql + "`r`nSELECT top 100 resource, count(resource) as 'Closed Tickets',sum(Hours_bill) as 'Hours Billed' 
FROM [cwwebapp_].[dbo].[v_company_time] where (( date>=DATEADD(week, DATEDIFF(week, 0, getdate()), 0) )) group by resource order by sum(hours_bill) desc;"
...
<th style=`"width:20%`">Hours Billed</th>
        ...
        $sql = $sql + "`r`nSELECT top 100 resource, count(resource) as 'Closed Tickets',sum(Hours_bill) as 'Hours Billed' 
FROM [cwwebapp_].[dbo].[v_company_time] where (( date>=DATEADD(month, DATEDIFF(month, 0, getdate()), 0) )) group by resource order by sum(hours_bill) desc;"
...
<th style=`"width:20%`">Hours Billed</th>
        ...
        $sql = $sql + "`r`nSELECT top 100 resource, count(resource) as 'Closed Tickets',sum(Hours_bill) as 'Hours Billed' 
FROM [cwwebapp_].[dbo].[v_company_time] where (( date>=DATEADD(year, DATEDIFF(year, 0, getdate()), 0) )) group by resource order by sum(hours_bill) desc;"
...
FROM [cwwebapp_].[dbo].[v_TimeRecords] 
